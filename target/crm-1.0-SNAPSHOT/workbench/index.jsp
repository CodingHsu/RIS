...
<body>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">RIS &nbsp;<span style="font-size: 12px;">&copy;2021&nbsp;首都师范大学</span></div>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass"><a href="javascript:void(0);" onclick="judgeprivilege('6','statistical_chart')" target="workareaFrame"><span class="glyphicon glyphicon-stats"></span> 统计图表</a></li>
