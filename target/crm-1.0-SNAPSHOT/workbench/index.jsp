	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="workbench/register/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 登记</a></li>
				<li class="liClass"><a href="workbench/sign_in/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-tag"></span> 签到</a></li>
				<li class="liClass"><a href="workbench/check/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-time"></span> 进行检查</a></li>
				<li class="liClass"><a href="workbench/write_report/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 填写报告</a></li>
				<li class="liClass"><a href="workbench/report_review/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-play-circle"></span> 报告审批</a></li>
				<li class="liClass"><a href="workbench/statistical_chart/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-search"></span> 统计图表</a></li>
				<li class="liClass"><a href="workbench/sys_config/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 系统配置</a></li>
