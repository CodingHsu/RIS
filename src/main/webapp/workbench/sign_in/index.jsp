...
<script type="text/javascript">
    $(function(){
        ...
        //重要信息不填则更新按钮失效（预约时间）
        /*$("#edit-scheduledProcedureStepStart").bind("input propertychange",function(){
            if($("#edit-scheduledProcedureStepStart").val().length>0){
                //没写东西
        ...
        $("#updateBtn").click(function () {
            $.ajax({
                ...
                data : {
                    ...
                    "scheduledProcedureStepStart" : $.trim($("#edit-scheduledProcedureStepStart").val())
                },
                type : "post",
                dataType : "json",
                success : function (data) {
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control time" autocomplete="off" id="edit-scheduledProcedureStepStart" name="scheduledProcedureStepStart">
                        </div>
                    </div>
