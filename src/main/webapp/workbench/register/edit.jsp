...
<script>
    $(function () {
        //进入修改界面，显示修改之前有的信息
        //病人信息
        $("#edit-patientname").val("${patient.name}");
        $("#edit-patientnamePinYin").val("${patient.namePinYin}");
        $("#edit-patientType").val("${patient.patientType}");
        $("#edit-inpatientNumber").val("${patient.inpatientNumber}");
        $("#edit-inpatientDepartment").val("${patient.inpatientDepartment}");
        $("#edit-inpatientBedNumber").val("${patient.inpatientBedNumber}");
...
<form action="workbench/register/update.do" id="registerForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        <input type="hidden" id="edit-accessionNumber" name="accessionNumber" value="${studyinfo.accessionNumber}">
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" autocomplete="off" id="edit-patientname" name="patientname" placeholder="支持自动补全(不存在则新建)">
        </div>
        <label for="edit-patientnamePinYin" class="col-sm-2 control-label">姓名拼音<span style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="edit-patientnamePinYin" name="patientnamePinYin">
        </div>
    </div>
