...
public class Patient {
    ...
    public String getInpatientBedNumber() {
        return inpatientBedNumber;
    }

    public void setInpatientBedNumber(String inpatientBedNumber) {
        this.inpatientBedNumber = inpatientBedNumber;
    }
